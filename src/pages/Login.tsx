  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (success) {
        ...
        toast({
          title: "Login failed",
          description: "Invalid email or password. Try demo@shadman.com / demo123",
          variant: "destructive",
        });
      }
    } catch (error) {
    ...
    <div className="min-h-screen bg-gradient-surface flex items-center justify-center px-4">
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          ...
          <h2 className="text-3xl font-bold text-tech-black">Welcome back</h2>
          <p className="mt-2 text-tech-gray">Sign in to your account</p>
        </div>
