...
const Signup: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setIsLoading(false);
    if (success) {
      toast({ title: 'Account created!', description: 'Welcome to Shadman Electronics!' });
      navigate('/');
    } else {
            ...
            <div>
              ...
              <div className="relative">
                <Input id="name" value={formData.name} onChange={(e) => setFormData({ ...formData, name: e.target.value })}
                  className="pl-10" placeholder="Enter your full name" required />
            ...
            <div>
              ...
              <div className="relative">
                <Input id="password" type={showPassword ? 'text' : 'password'} value={formData.password}
                  ...
                  className="pl-10 pr-10" placeholder="Create a password (min 6 chars)" required />
